...
class ChoiceEntity extends Component {
  state = {
    // modalVisible: false,
    noteVisible: false,
    note: null
  ...
  render () {
    ...
    return (
      <div className='inputbox final-topic lg-final-choice-entity wow fadeIn'>
        <h1 className='inputbox__title mt-2'>{title}</h1>
        <div className='final-body'>
          <p>{reactHtmlParser(message)}</p>
          <br />
          <div className='text-center lg-description mt-2 mb-3'>
