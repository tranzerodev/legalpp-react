    ...
    <div className='preview'>
      ...
      <div className='content'>
        ...
        <ol>
          ...
          <li>
            ...
            <div className='info'>
              ...
              <span className='info-content'>
                {' '}{info.registered_agent_address_street} <br />
                {info.registered_agent_address_city}
                ,
                {' '}
                {info.registered_agent_address_state}
                {' '}
                {info.registered_agent_address_zipcode}
              </span>
            </div>
            <div className='info'>
          ...
          <li>
            The board of directors of the corporation shall have the power to adopt, amend or repeal the by-laws of the corporation, subject to the power of the stockholders of the corporation to alter or repeal any bylaw whether adopted by them or otherwise.
          </li>
