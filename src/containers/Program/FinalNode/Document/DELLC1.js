    ...
    <div className='preview'>
      ...
      <div className='content px-5'>
        ...
        <p>
          ...
          ,
          {' '}
          {data.company_address_street}
          ,
          {' '}
          {data.company_address_city}
          , DE
          {' '}
          {data.company_address_zipcode}
          .
        </p>
        ...
        <div className='p'>
          ...
          <div className='info'>
            ...
            <span className='info-content'> {data.company_name} </span>
          </div>
          <div className='info my-0'>
            <span className='info-title'>Address :</span>
            <span className='info-content'>
              {' '}{data.company_address_street}<br />
              {data.company_address_city}, DE {data.company_address_zipcode}
            </span>
          </div>
        </div>
        <p>
