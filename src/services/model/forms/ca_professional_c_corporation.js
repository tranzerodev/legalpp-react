/* eslint-disable */
export default {
  name: "ca_professional_c_corporation",
  description: "Creating The California Professional C-Corporation",
  start: "input_1",
  kind: "Form",
  step: 9,
  nodes: [
