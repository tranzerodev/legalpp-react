  ...
  nodes: [
    {
      ...
      content: {
        ...
        fields: [
          ...
          { kind: 'choice', label: 'A Profession', next: 'yesno_1' },
          {
            kind: 'choice',
      ...
      content: {
        ...
        note: {
          ...
          content: `<ul>
            ...
            <li>The name of your corporation must include one of the following words: association, company, corporation, club, foundation, fund, incorporated, institute, society, union, syndicate, limited or one of the abbreviations thereof (with or without punctuation).</li>
            ...
            <li>You should input the entire name of the company as you would like it to appear on the records of the Delaware Secretary of State.</li>
          </ul>`,
        },
      },
    },
